...
class DataCleaning:
    ...
    def __fill_missing_comune_residenza(self, df:pd.DataFrame, codice_comune_to_nome:pd.Series) -> pd.DataFrame:
        '''
    ...
    def __remove_comune_residenza(self, df:pd.DataFrame) -> pd.DataFrame:
        '''
    ...
    # NOT USED 
    def __impute_ora_inizio_and_fine_erogazione(self, df:pd.DataFrame) -> pd.DataFrame:
        '''
    ...
    def __remove_disdette(self, df:pd.DataFrame) -> pd.DataFrame: 
        '''
    ...
    def identify_and_remove_outliers_boxplot(self, df:pd.DataFrame, columns:list, threshold:float=3) -> pd.DataFrame:
        '''
    ...
    def __smooth_noisy_data(self, df:pd.DataFrame, column:str, window_size:int=3) -> pd.DataFrame:
        '''
    ...
    def impute_durata_erogazione(self, df:pd.DataFrame) -> pd.DataFrame:
        '''
    ...
    def __missing_values(self, df:pd.DataFrame, missing_threshold) -> pd.DataFrame:
        '''
    ...
    def data_cleaning_execution(self, missing_threshold:float, config:dict) -> pd.DataFrame:
        ...
        df = self.__fill_missing_comune_residenza(df, codice_comune_to_nome) 

        df = self.__remove_comune_residenza(df)
